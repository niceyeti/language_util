"""
DO NOT MODIFY THIS. THIS IS A COPY FROM SENTINEL
...
The intent of this object is to have the cleanest object that makes a best-effort to convert unicode/latin-1
